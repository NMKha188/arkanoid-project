...
public class InGameStatus {
    ...
    private static final Group group = new Group(topBorder, downBorder, leftBorder, rightBorder, scoreText, levelText, livesText, LineBall.lineBall);
    ...
    public static void loseLife() {
        ...
        updateTexts();
        if (lives == 0) {
            System.out.println("level is: " + SaveGame.getLevelFromFile());
